...
exports.run = async (client, message, args) => {
  ...
  try {
    ...
    evewholink =
      `https://evewho.com/pilot/${encodeURIComponent(character.name)}`;
    let monthdata = zinfo.months[today] ? zinfo.months[today] : "0";
    //console.log(monthdata)
    let monthkills = monthdata.shipsDestroyed ? monthdata.shipsDestroyed : "0";
    let monthdeaths = monthdata.shipsLost ? monthdata.shipsLost : "0";
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField("Monthly K/D:", monthkills + " / " + monthdeaths, false)
      .addField(
        "Alltime K/D:",
        zinfo.shipsDestroyed + " / " + zinfo.shipsLost,
        false
      )
      .addField(
        "Links:",
